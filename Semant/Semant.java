...
public class Semant {
  ...
  Exp transDec(Absyn.TypeDec d) {
    ...
    Hashtable<Symbol.Symbol,Symbol.Symbol> hash = new Hashtable<Symbol.Symbol,Symbol.Symbol>();
  ...
  Exp transDec(Absyn.FunctionDec d) {
    ...
    for (Absyn.FunctionDec f = d; f != null; f = f.next) {
      ...
      Types.RECORD fields = transTypeFields(new Hashtable<Symbol.Symbol,Symbol.Symbol>(), f.params);
  ...
  private Types.RECORD transTypeFields(Hashtable<Symbol.Symbol,Symbol.Symbol> hash, Absyn.FieldList f) {
    if (f == null)
      return null;
  ...
  Type transTy(Absyn.RecordTy t) {
    Types.RECORD type = transTypeFields(new Hashtable<Symbol.Symbol,Symbol.Symbol>(), t.fields);
    if (type != null)
      return type;
    return VOID;
  }
